...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x14a994;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(28800000000);
...
const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX_V3              = 2200000;
...
const char     CRYPTONOTE_NAME[]                             = "Roto2coin";
...
const int      RPC_DEFAULT_PORT                              =  13300;
...
{
    {  0xbb, 0x02, 0x4e, 0xec, 0xee, 0x23, 0xea, 0xa1, 0xae, 0xfe, 0xef, 0xce, 0xe6, 0xec, 0xf4, 0xe2  }
};

const char* const SEED_NODES[] = {
  "178.62.55.144:13000",//rock
  "178.62.11.164:13000", //cision
};
} // CryptoNote
